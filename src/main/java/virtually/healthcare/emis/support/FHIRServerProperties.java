package virtually.healthcare.emis.support;
...
public class FHIRServerProperties {
    ...
    static final String FTPSERVER_URL = "message.ftp.url";
    static final String FTPSERVER_USERNAME = "message.ftp.username";
    static final String FTPSERVER_PWD = "message.ftp.pwd";
    ...
    public static String getFTPServerUrl() {
        String emisUri =FHIRServerProperties.getProperty(FTPSERVER_URL, "ec2-18-130-139-120.eu-west-2.compute.amazonaws.com/docs");
       log.debug("FTP Server "+emisUri);
        return emisUri;
    }
    public static String getFtpserverUsername() {
        String emisUri =FHIRServerProperties.getProperty(FTPSERVER_USERNAME);
      //  log.warn("FTP Server "+emisUri);
        return emisUri;
    }
    public static String getFtpserverPwd() {
        String emisUri =FHIRServerProperties.getProperty(FTPSERVER_PWD);
     //   log.warn("FTP Server "+emisUri);
        return emisUri;
    }
